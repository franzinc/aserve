...
| **`crl-file`**                                                                                                           | **`nil`**                          | see [SSL/TLS](#ssltls) for the use of this argument.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **`crl-check`**                                                                                                           | **`nil`**                          | see [SSL/TLS](#ssltls) for the use of this argument.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| **`connect-timeout`**                                                                                                              | **`nil`**                          | If given this overrides the value of the timeout argument when connecting to a server                                                                                                                                                                                                                                                                                                                                         |
| **`read-timeout`**                                                                                                              | **`nil`**                          | If given this overrides the value of the timeout argument when reading from a response from a server.                                                                                                                                                                                                                                                                                                                                         |
| **`write-timeout`**                                                                                                              | **`nil`**                          | If given this overrides the value of the timeout argument when writing data to a server.                                                                                                                                                                                                                                                                                                                                       |
...
The `:crl-file` and `:crl-check` keyword arguments to 
**`net.aserve.client:do-http-request`** are used to test if the SSL
certificate should be trusted.  These arguments are passed 
to 
[**`acl-socket:make-ssl-server-stream`**](https://franz.com/support/documentation/current/doc/operators/socket/make-ssl-server-stream.htm).
See the documentation for that function for information on
constructing value valid values for these keywords.
